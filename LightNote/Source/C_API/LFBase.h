...
LN_CLASS(LNIntTable)
	...
	*/
	LN_INSTANCE_API LNResult LNIntTable_Create(LN_HANDLE(LNIntTable)* intTable, int xSize, int ySize LN_DEFAULT_ARG(1), int zSize LN_DEFAULT_ARG(1));
	...
	*/
	LN_INSTANCE_API LNResult LNIntTable_CreateFromSrcData(LN_HANDLE(LNIntTable)* intTable, int xSize, int ySize, int zSize, const int* srcData);
	...
	*/
	LN_INSTANCE_API LNResult LNIntTable_SetValue(LN_HANDLE(LNIntTable) intTable, int xSize, int ySize, int zSize, int value);
	...
	/**
		...
		@details	変更前のデータは保持されます。
	*/
	LN_INSTANCE_API LNResult LNIntTable_GetValue(LN_HANDLE(LNIntTable) intTable, int xSize, int ySize, int zSize, int* value);
	...
	/**
		...
		@details	変更前のデータは保持されます。
	*/
	LN_INSTANCE_API LNResult LNIntTable_Resize(LN_HANDLE(LNIntTable) intTable, int xSize, int ySize, int zSize);
	...
	*/
	LN_INSTANCE_API LNResult LNIntTable_GetXSize(LN_HANDLE(LNIntTable) intTable, int* xSize);
	...
	*/
	LN_INSTANCE_API LNResult LNIntTable_GetYSize(LN_HANDLE(LNIntTable) intTable, int* ySize);
	...
	*/
	LN_INSTANCE_API LNResult LNIntTable_GetZSize(LN_HANDLE(LNIntTable) intTable, int* zSize);
