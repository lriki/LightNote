...
Vector3 Matrix::ToEulerAngles(RotationOrder order, bool* locked_)
{
	bool locked;
...
//
//-----------------------------------------------------------------------------
bool Matrix::ContainsNaNOrInf() const
{
	return
...
//==============================================================================
	...
	{
		return 
			LMath::isNaN( m[0][0] ) || LMath::isNaN( m[0][1] ) || LMath::isNaN( m[0][2] ) || LMath::isNaN( m[0][3] ) ||
			LMath::isNaN( m[1][0] ) || LMath::isNaN( m[1][1] ) || LMath::isNaN( m[1][2] ) || LMath::isNaN( m[1][3] ) ||
			LMath::isNaN( m[2][0] ) || LMath::isNaN( m[2][1] ) || LMath::isNaN( m[2][2] ) || LMath::isNaN( m[2][3] ) ||
			LMath::isNaN( m[3][0] ) || LMath::isNaN( m[3][1] ) || LMath::isNaN( m[3][2] ) || LMath::isNaN( m[3][3] );
	}
